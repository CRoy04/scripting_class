...
document.getElementById('column1').innerHTML="<h3>Holy moly! it's Tyler Toffoli!</h3>";

document.getElementById('column1').innerHTML+="<p> Whoah! I can add more to this!</p>"

document.getElementById('column1').innerHTML+="<p>In this world Spider-Man, you either drip or you drown</p>"
...
document.getElementById('column2').style.color="#47A8C1";
...
if(weapon=="Raygun"){
    console.log("I GOT THE RAYGUN!");
}else if(weapon=="Thundergun"){
    console.log("Weapon does massive damage.")
}else{
...
//if the weapon is thundergun the damage is 50
//but if the weapon is raygun the damage is 25
//otherwise the damage will be zero
if(weapon=="Thundergun"){
    damage=50;
...
document.getElementById('column3').innerHTML += "<p>"+weapon+ " does this much damage: "+damage+"</p>";
